(function (global, factory) {
  ...
  var DatetimePanel = {
    ...
    props: _objectSpread2(_objectSpread2(_objectSpread2({}, __vue_component__$5.props), __vue_component__$9.props), {}, {
      showTimePanel: {
        type: Boolean,
        default: undefined
      }
    ...
    render: function render() {
      var h = arguments[0];
      var calendarProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this, Object.keys(__vue_component__$5.props))), {}, {
          type: 'date',
      ...
      var timeProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this, Object.keys(__vue_component__$9.props))), {}, {
          showTimeHeader: true,
          value: this.currentValue
        }),
        on: {
  ...
  var DatetimeRange = {
    ...
    render: function render() {
      var h = arguments[0];
      var calendarProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this, Object.keys(CalendarRange.props))), {}, {
          type: 'date',
          value: this.currentValue
        }),
        on: {
      ...
      var timeProps = {
        props: _objectSpread2(_objectSpread2({}, pick(this, Object.keys(TimeRange.props))), {}, {
          value: this.currentValue,
          showTimeHeader: true
        }),
        on: {
  ...
  var script$8 = {
    ...
    computed: {
      ...
      currentComponentProps: function currentComponentProps() {
        var props = _objectSpread2(_objectSpread2({}, pick(this, Object.keys(this.currentComponent.props))), {}, {
          value: this.currentValue
        });
    ...
    methods: {
      ...
      togglePopup: function togglePopup(evt) {
        if (this.defaultOpen) {
          this.closePopup();
        } else {
          this.openPopup();
