    ...
    renderSidebar() {
      ...
      return (
        <div class={`${prefixClass}-datepicker-sidebar`}>
          {this.renderSlot('sidebar', null, { value: this.currentValue, emit: this.emitValue })}
    ...
    renderHeader() {
      return (
        <div class={`${this.prefixClass}-datepicker-header`}>
          {this.renderSlot('header', null, { value: this.currentValue, emit: this.emitValue })}
        </div>
      );
    },
    renderFooter() {
      ...
      return (
        <div class={`${prefixClass}-datepicker-footer`}>
          {this.renderSlot('footer', null, { value: this.currentValue, emit: this.emitValue })}
          {this.confirm ? (
            <button
              type="button"
